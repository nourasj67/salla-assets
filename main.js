                    ...
                    <div class="pricing-cards" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 40px; max-width: 950px; margin: 0 auto;">
                        ...
                        <div class="pricing-card basic-plan" style="background: white; border-radius: 25px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.12); transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); display: flex; flex-direction: column; height: 100%;">
                            ...
                            <div class="card-body" style="padding: 35px 25px; flex: 1; display: flex; flex-direction: column;">
                                <ul style="list-style: none; padding: 0; margin: 0;">
                                    <li class="feature-item" style="padding: 14px 12px; border-bottom: 1px solid #e8e8e8; color: #2c3e50; font-size: 1rem; text-align: center; line-height: 1.5; min-height: 50px; display: flex; align-items: center; justify-content: center;">برنامج متعدد اللغات</li>
                                    ...
                                    <li class="feature-item" style="padding: 14px 12px; border-bottom: 1px solid #e8e8e8; color: #2c3e50; font-size: 1rem; text-align: center; line-height: 1.5; min-height: 50px; display: flex; align-items: center; justify-content: center;">عدد الفواتير : غير محدود</li>
                                    ...
                                    <li class="feature-item" style="padding: 14px 12px; color: #2c3e50; font-size: 1rem; text-align: center; line-height: 1.5; min-height: 50px; display: flex; align-items: center; justify-content: center; font-weight: bold;">السعر 660 ريال فقط سنويًا</li>
                        ...
                        <div class="pricing-card standard-plan" style="background: white; border-radius: 25px; overflow: hidden; box-shadow: 0 15px 50px rgba(0,0,0,0.18); transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); border: 3px solid #5dade2; display: flex; flex-direction: column; position: relative; height: 100%;">
                            ...
                            <div class="card-header" style="background: linear-gradient(135deg, #145a86 0%, #1e7ba6 100%); padding: 55px 25px 30px 25px; text-align: center; color: white;">
                                ...
                                <p style="font-size: 0.95rem; margin: 5px 0 0 0; opacity: 0.95; font-weight: 500;">AL MO'TAMAN LITE - STANDARD</p>
                            </div>
                            ...
                            <div class="card-body" style="padding: 35px 25px; flex: 1; display: flex; flex-direction: column;">
                                ...
                                <ul style="list-style: none; padding: 0; margin: 0;">
                                    ...
                                    <li class="feature-item highlighted" style="padding: 14px 12px; color: #2c3e50; font-size: 1rem; text-align: center; line-height: 1.5; background: linear-gradient(90deg, transparent 0%, #e3f2fd 100%); min-height: 70px; display: flex; align-items: center; justify-content: center; font-weight: bold;">السعر 1000 ريال فقط سنويًا</li>
